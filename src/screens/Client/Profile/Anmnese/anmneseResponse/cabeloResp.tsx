...
const FichaAnamneseBase = () => {
  ...
  // UseEffect para chamar a função de busca assim que o componente for montado
  useEffect(() => {
    buscarRespostas();
  }, []);
  ...
  return (
    <View style={formStyles.container}>
      <ScrollView>
        ...
        {/* Pergunta 5 */}
        <View style={formStyles.block}>
          <Text style={formStyles.Text}>Já realizou algum procedimento estético facial ou corporal?</Text>
          <View style={formStyles.pickerContainer}>
            <Picker
              style={formStyles.picker}
        ...
        {/* Pergunta 6 */}
        <View style={formStyles.block}>
          <Text style={formStyles.Text}>Tem algum hábito que possa comprometer o resultado do procedimento?</Text>
          <View style={formStyles.pickerContainer}>
            <Picker
              style={formStyles.picker}
        ...
        {/* Pergunta 7 */}
        <View style={formStyles.block}>
          <Text style={formStyles.Text}>Já realizou algum procedimento estético comigo?</Text>
          <View style={formStyles.pickerContainer}>
            <Picker
              style={formStyles.picker}
